...
import { BorrowerUncheckedUpdateManyWithoutReferenceInput } from './borrower-unchecked-update-many-without-reference.input';

@InputType()
export class BorrowerUncheckedUpdateWithoutReferenceInput {
    ...
    @Field(() => BorrowerUncheckedUpdateManyWithoutReferenceInput, {nullable:true})
    Borrower?: BorrowerUncheckedUpdateManyWithoutReferenceInput;
}
