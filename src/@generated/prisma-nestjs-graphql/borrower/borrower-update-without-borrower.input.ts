...
import { BorrowerUpdateOneWithoutBorrowerInput } from './borrower-update-one-without-borrower.input';
import { ContractUpdateManyWithoutBorrowerInput } from '../contract/contract-update-many-without-borrower.input';

@InputType()
export class BorrowerUpdateWithoutBorrowerInput {
    ...
    @Field(() => BorrowerUpdateOneWithoutBorrowerInput, {nullable:true})
    reference?: BorrowerUpdateOneWithoutBorrowerInput;
