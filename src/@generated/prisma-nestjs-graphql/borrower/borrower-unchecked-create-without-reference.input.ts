...
import { BorrowerUncheckedCreateNestedManyWithoutReferenceInput } from './borrower-unchecked-create-nested-many-without-reference.input';

@InputType()
export class BorrowerUncheckedCreateWithoutReferenceInput {
    ...
    @Field(() => BorrowerUncheckedCreateNestedManyWithoutReferenceInput, {nullable:true})
    Borrower?: BorrowerUncheckedCreateNestedManyWithoutReferenceInput;
}
