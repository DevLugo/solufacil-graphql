...
import { BorrowerUpdateManyWithoutReferenceInput } from './borrower-update-many-without-reference.input';

@InputType()
export class BorrowerUpdateWithoutReferenceInput {
    ...
    @Field(() => BorrowerUpdateManyWithoutReferenceInput, {nullable:true})
    Borrower?: BorrowerUpdateManyWithoutReferenceInput;
}
