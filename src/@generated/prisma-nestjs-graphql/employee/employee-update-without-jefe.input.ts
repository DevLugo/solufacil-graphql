...
import { EmployeeUpdateManyWithoutJefeInput } from './employee-update-many-without-jefe.input';

@InputType()
export class EmployeeUpdateWithoutJefeInput {
    ...
    @Field(() => EmployeeUpdateManyWithoutJefeInput, {nullable:true})
    Employee?: EmployeeUpdateManyWithoutJefeInput;
}
