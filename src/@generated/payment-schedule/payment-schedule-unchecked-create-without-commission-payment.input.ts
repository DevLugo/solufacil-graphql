...
@InputType()
export class PaymentScheduleUncheckedCreateWithoutCommissionPaymentInput {
    ...
    @Field(() => LoanPaymentUncheckedCreateNestedManyWithoutPaymentSchedulesInput, {nullable:true})
