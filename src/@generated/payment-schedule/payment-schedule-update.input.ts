...
@InputType()
export class PaymentScheduleUpdateInput {
    ...
    @Field(() => LoanUpdateOneRequiredWithoutPaymentScheduleInput, {nullable:true})
    loan?: LoanUpdateOneRequiredWithoutPaymentScheduleInput;

    @Field(() => LoanPaymentUpdateManyWithoutPaymentSchedulesInput, {nullable:true})
    loanPayments?: LoanPaymentUpdateManyWithoutPaymentSchedulesInput;

    @Field(() => CommissionPaymentUpdateManyWithoutPaymentScheduleInput, {nullable:true})
