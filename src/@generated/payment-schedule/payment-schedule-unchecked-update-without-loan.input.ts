...
@InputType()
export class PaymentScheduleUncheckedUpdateWithoutLoanInput {
    ...
    @Field(() => LoanPaymentUncheckedUpdateManyWithoutPaymentSchedulesInput, {nullable:true})
    loanPayments?: LoanPaymentUncheckedUpdateManyWithoutPaymentSchedulesInput;

    @Field(() => CommissionPaymentUncheckedUpdateManyWithoutPaymentScheduleInput, {nullable:true})
