...
exports.PhoneUncheckedCreateNestedManyWithoutBorrowerInput = void 0;
...
let PhoneUncheckedCreateNestedManyWithoutBorrowerInput = class PhoneUncheckedCreateNestedManyWithoutBorrowerInput {
};
__decorate([
    (0, graphql_1.Field)(() => [phone_create_without_borrower_input_1.PhoneCreateWithoutBorrowerInput], { nullable: true }),
    __metadata("design:type", Array)
], PhoneUncheckedCreateNestedManyWithoutBorrowerInput.prototype, "create", void 0);
__decorate([
    ...
    __metadata("design:type", Array)
], PhoneUncheckedCreateNestedManyWithoutBorrowerInput.prototype, "connectOrCreate", void 0);
__decorate([
...
], PhoneUncheckedCreateNestedManyWithoutBorrowerInput.prototype, "createMany", void 0);
__decorate([
    (0, graphql_1.Field)(() => [phone_where_unique_input_1.PhoneWhereUniqueInput], { nullable: true }),
    __metadata("design:type", Array)
], PhoneUncheckedCreateNestedManyWithoutBorrowerInput.prototype, "connect", void 0);
PhoneUncheckedCreateNestedManyWithoutBorrowerInput = __decorate([
    (0, graphql_2.InputType)()
], PhoneUncheckedCreateNestedManyWithoutBorrowerInput);
exports.PhoneUncheckedCreateNestedManyWithoutBorrowerInput = PhoneUncheckedCreateNestedManyWithoutBorrowerInput;
//# sourceMappingURL=phone-unchecked-create-nested-many-without-borrower.input.js.map