...
exports.LoanPaymentUncheckedCreateNestedManyWithoutLoanInput = void 0;
...
let LoanPaymentUncheckedCreateNestedManyWithoutLoanInput = class LoanPaymentUncheckedCreateNestedManyWithoutLoanInput {
};
__decorate([
    (0, graphql_1.Field)(() => [loan_payment_create_without_loan_input_1.LoanPaymentCreateWithoutLoanInput], { nullable: true }),
    __metadata("design:type", Array)
], LoanPaymentUncheckedCreateNestedManyWithoutLoanInput.prototype, "create", void 0);
__decorate([
    ...
    __metadata("design:type", Array)
], LoanPaymentUncheckedCreateNestedManyWithoutLoanInput.prototype, "connectOrCreate", void 0);
__decorate([
...
], LoanPaymentUncheckedCreateNestedManyWithoutLoanInput.prototype, "createMany", void 0);
__decorate([
    (0, graphql_1.Field)(() => [loan_payment_where_unique_input_1.LoanPaymentWhereUniqueInput], { nullable: true }),
    __metadata("design:type", Array)
], LoanPaymentUncheckedCreateNestedManyWithoutLoanInput.prototype, "connect", void 0);
LoanPaymentUncheckedCreateNestedManyWithoutLoanInput = __decorate([
    (0, graphql_2.InputType)()
], LoanPaymentUncheckedCreateNestedManyWithoutLoanInput);
exports.LoanPaymentUncheckedCreateNestedManyWithoutLoanInput = LoanPaymentUncheckedCreateNestedManyWithoutLoanInput;
//# sourceMappingURL=loan-payment-unchecked-create-nested-many-without-loan.input.js.map