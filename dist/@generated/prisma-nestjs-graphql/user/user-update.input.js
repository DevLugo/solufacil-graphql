...
const employee_update_many_without_user_input_1 = require("../employee/employee-update-many-without-user.input");
...
__decorate([
    (0, graphql_1.Field)(() => employee_update_many_without_user_input_1.EmployeeUpdateManyWithoutUserInput, { nullable: true }),
    __metadata("design:type", employee_update_many_without_user_input_1.EmployeeUpdateManyWithoutUserInput)
], UserUpdateInput.prototype, "Employee", void 0);
