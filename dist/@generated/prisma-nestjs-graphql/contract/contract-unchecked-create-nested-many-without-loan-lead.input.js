...
exports.ContractUncheckedCreateNestedManyWithoutLoanLeadInput = void 0;
...
let ContractUncheckedCreateNestedManyWithoutLoanLeadInput = class ContractUncheckedCreateNestedManyWithoutLoanLeadInput {
};
__decorate([
    (0, graphql_1.Field)(() => [contract_create_without_loan_lead_input_1.ContractCreateWithoutLoanLeadInput], { nullable: true }),
    __metadata("design:type", Array)
], ContractUncheckedCreateNestedManyWithoutLoanLeadInput.prototype, "create", void 0);
__decorate([
    ...
    __metadata("design:type", Array)
], ContractUncheckedCreateNestedManyWithoutLoanLeadInput.prototype, "connectOrCreate", void 0);
__decorate([
...
], ContractUncheckedCreateNestedManyWithoutLoanLeadInput.prototype, "createMany", void 0);
__decorate([
    (0, graphql_1.Field)(() => [contract_where_unique_input_1.ContractWhereUniqueInput], { nullable: true }),
    __metadata("design:type", Array)
], ContractUncheckedCreateNestedManyWithoutLoanLeadInput.prototype, "connect", void 0);
ContractUncheckedCreateNestedManyWithoutLoanLeadInput = __decorate([
    (0, graphql_2.InputType)()
], ContractUncheckedCreateNestedManyWithoutLoanLeadInput);
exports.ContractUncheckedCreateNestedManyWithoutLoanLeadInput = ContractUncheckedCreateNestedManyWithoutLoanLeadInput;
//# sourceMappingURL=contract-unchecked-create-nested-many-without-loan-lead.input.js.map