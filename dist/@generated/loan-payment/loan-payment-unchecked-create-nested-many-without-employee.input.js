...
exports.LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput = void 0;
...
let LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput = class LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput {
};
__decorate([
    (0, graphql_1.Field)(() => [loan_payment_create_without_employee_input_1.LoanPaymentCreateWithoutEmployeeInput], { nullable: true }),
    __metadata("design:type", Array)
], LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput.prototype, "create", void 0);
__decorate([
    ...
    __metadata("design:type", Array)
], LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput.prototype, "connectOrCreate", void 0);
__decorate([
...
], LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput.prototype, "createMany", void 0);
__decorate([
    (0, graphql_1.Field)(() => [loan_payment_where_unique_input_1.LoanPaymentWhereUniqueInput], { nullable: true }),
    __metadata("design:type", Array)
], LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput.prototype, "connect", void 0);
LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput = __decorate([
    (0, graphql_2.InputType)()
], LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput);
exports.LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput = LoanPaymentUncheckedCreateNestedManyWithoutEmployeeInput;
//# sourceMappingURL=loan-payment-unchecked-create-nested-many-without-employee.input.js.map