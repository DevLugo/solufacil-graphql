...
exports.PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput = void 0;
...
let PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput = class PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput {
};
__decorate([
    (0, graphql_1.Field)(() => [payment_schedule_create_without_loan_input_1.PaymentScheduleCreateWithoutLoanInput], { nullable: true }),
    __metadata("design:type", Array)
], PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput.prototype, "create", void 0);
__decorate([
    ...
    __metadata("design:type", Array)
], PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput.prototype, "connectOrCreate", void 0);
__decorate([
...
], PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput.prototype, "createMany", void 0);
__decorate([
    (0, graphql_1.Field)(() => [payment_schedule_where_unique_input_1.PaymentScheduleWhereUniqueInput], { nullable: true }),
    __metadata("design:type", Array)
], PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput.prototype, "connect", void 0);
PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput = __decorate([
    (0, graphql_2.InputType)()
], PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput);
exports.PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput = PaymentScheduleUncheckedCreateNestedManyWithoutLoanInput;
//# sourceMappingURL=payment-schedule-unchecked-create-nested-many-without-loan.input.js.map